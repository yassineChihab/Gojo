...
class ProfileMenuFragment : Fragment(R.layout.fragment_profile_menu) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ((activity) as HomeActivity).toolbarIcon?.setOnClickListener {
           navController.navigate(R.id.action_profileMenuFragment_to_sushiFragment)


        }
        binding.mesCommande.setOnClickListener {
            navController.navigate(R.id.action_profileMenuFragment_to_vosCommandesFragment)        }
